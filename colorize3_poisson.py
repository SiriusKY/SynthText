    ...
    def __init__(self,alpha,color):
        ...
        if color.ndim==1: # constant color for whole layer
            ...
            if ncol == 3 : 
                ...
                # print('colorize3_poisson.py -> line 36 self.color:',self.color[0][0][:])
...
class Colorize(object):
    ...
    def color_text(self, text_arr, h, bg_arr):
        ...
        # print('colorize3_poisson.py -> line 325 fg_color:',fg_col,'bg_color',bg_col)
    ...
    def process(self, text_arr, bg_arr, min_h):
        ...
        # print('l_text.color:',l_text.color[0][0][:])
        text_color_rgb=[]
        text_color_rgb.append(l_text.color[0][0][0])
        text_color_rgb.append(l_text.color[0][0][1])
        text_color_rgb.append(l_text.color[0][0][2])
    ...
    def color(self, bg_arr, text_arr, hs, place_order=None, pad=20):
        ...
        for i in place_order[::-1]:
            ...
            rdr0, text_color_rgb = self.process(text_patch, bg, hs[i])
            rendered.append(rdr0)
            # text_color.append(text_color_rgb)

            bg_arr[l[0]:l[0]+w,l[1]:l[1]+h,:] = rdr0#rendered[-1]

            # print(text_color)
            # print('in for')
            return bg_arr, text_color_rgb

        # print('out for')
        # return bg_arr, text_color
